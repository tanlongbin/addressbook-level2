...
== Searching all persons containing any keyword in their tags: `search`

Search for persons who are tagged with any of the given keywords. +
Format: `search KEYWORD [MORE_KEYWORDS]`

[NOTE]
====
The search is case sensitive, the order of the keywords does not matter, only the tag is searched,
and persons with tags matching at least one keyword will be returned (i.e. `OR` search).
====
...
* `find criminal friend` +
Returns Any person having tags `criminal` or `friend`.
